...
00032 \textcolor{keyword}{template} <\textcolor{keyword}{typename} MyListElementType>
\hypertarget{numbergenerator_8h_source_l00033}{}\hyperlink{class_number_generator_ab3c0d704683453456684ec24fb771334}{00033} \hyperlink{class_my_list}{MyList<MyListElementType>} \textcolor{keyword}{static} \hyperlink{class_number_generator_ab3c0d704683453456684ec24fb771334}{generateNumbers}(\textcolor{keywordtype}{int} range, \textcolor{keywordtype}{int} 
      quantity)
00034 \{
00035         \hyperlink{class_my_list}{MyList<MyListElementType>} &myList = *\textcolor{keyword}{new} 
...
00041                 myList.\hyperlink{class_my_list_a52dad29ecf7522b86df8daa3aa74702d}{push\_back}(rand()%range);
00042                 randomTime = clock();
00043         \}
00044         \textcolor{keywordflow}{return} myList;
00045 \}
00046 
00053 \textcolor{keyword}{static} std::string *\hyperlink{class_number_generator_afed5ae8efb72655770753790714b7643}{generateStrings}(\textcolor{keywordtype}{int} ileStringow);
00054 
00055 
00056 
00057 \textcolor{comment}{//using DataFrame::operator=;}
00058 
00059 \};
00060 
