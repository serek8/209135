...
00035 
00045         \textcolor{keywordtype}{int} \hyperlink{class_data_frame_a617ef21804065f31115c01527155f499}{loadDataFromFile}();
00046 
00052         \textcolor{keywordtype}{int} \hyperlink{class_data_frame_a03cc3ac606fdb8a2dbcaea5d429cf208}{saveDataToFile}();
00053 
00059         \hyperlink{class_data_frame}{DataFrame} \hyperlink{class_data_frame_ab7dddb09f5ee9dc4a5783136dad01962}{operator= }(\hyperlink{class_data_frame}{DataFrame} dataframe);
\hypertarget{dataframe_8h_source_l00060}{}\hyperlink{class_data_frame_a1360ddf00d717392fe1292bc1e1990ff}{00060}         \textcolor{keyword}{virtual} \hyperlink{class_data_frame_a1360ddf00d717392fe1292bc1e1990ff}{~DataFrame}() \{\}
00061 
00062 
00063 \};
00064 
00065 
00066 
00067 \textcolor{preprocessor}{#endif }\textcolor{comment}{/* DATAFRAME\_H\_ */}\textcolor{preprocessor}{}
\end{DoxyCode}
